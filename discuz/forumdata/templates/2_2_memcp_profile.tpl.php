...
0
|| checktplrefresh('/home/yaoyao/git/discuz/discuz/././templates/mobile/memcp_profile.htm', '/home/yaoyao/git/discuz/discuz/././templates/mobile/header.htm', 1538279869, '2', './templates/mobile')
|| checktplrefresh('/home/yaoyao/git/discuz/discuz/././templates/mobile/memcp_profile.htm', '/home/yaoyao/git/discuz/discuz/././templates/mobile/seccheck.htm', 1538279869, '2', './templates/mobile')
|| checktplrefresh('/home/yaoyao/git/discuz/discuz/././templates/mobile/memcp_profile.htm', '/home/yaoyao/git/discuz/discuz/././templates/mobile/personal_navbar.htm', 1538279869, '2', './templates/mobile')
|| checktplrefresh('/home/yaoyao/git/discuz/discuz/././templates/mobile/memcp_profile.htm', '/home/yaoyao/git/discuz/discuz/././templates/mobile/footer.htm', 1538279869, '2', './templates/mobile')
|| checktplrefresh('/home/yaoyao/git/discuz/discuz/././templates/mobile/memcp_profile.htm', '/home/yaoyao/git/discuz/discuz/././templates/mobile/jsmenu.htm', 1538279869, '2', './templates/mobile')
;?>
...
<!--<? if($forum['ismoderator']) { ?>-->
	<link href="forumdata/cache/style_2_moderator.css?DV3" rel="stylesheet" type="text/css" />
<!--<? } ?>--><script src="<?=$jspath?>jquery-3.3.1.min.js?<?=VERHASH?>" type="text/javascript"></script>
...
<div class="main">
<script src="<?=$jspath?>jquery.mb.flipText.js?<?=VERHASH?>" type="text/javascript"></script>
<script src="<?=$jspath?>mbExtruder.js?<?=VERHASH?>" type="text/javascript"></script>
<div class="content">
...
<tr>
<th><label for="msnnew">微信</label></th>
<td>
...
<? if($icp) { ?>(<a href="http://www.miibeian.gov.cn/" target="_blank"><?=$icp?></a>)<? } if($allowviewstats) { ?><span class="pipe">|</span><a href="stats.php">论坛统计</a><? } if($statcode) { ?><span class="pipe">| <?=$statcode?></span><? } ?>
