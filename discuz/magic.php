...
if ($action == 'index') {
        ...
        if ($operation == 'use') {
            ...
            if (! submitcheck('operatesubmit')) {
                ...
                if (! submitcheck('usesubmit')) {
                    ...
                    $username = dhtmlspecialchars($username);
                    $magicselect = array(
                        $magicid => 'selected="selected"'
                    );
                    $magiclist = $typeid ? magicselect($discuz_uid, $typeid, array(
                        'magic' => array(
                            'magicid',
                            'name',
                            'description'
    ...
    if (empty($operation) || $operation == 'my' || submitcheck('searchsubmit')) {
        ...
        $ascdesc = isset($ascdesc) && in_array(strtoupper($ascdesc), array(
            'ASC',
            'DESC'
        )) ? strtoupper($ascdesc) : 'DESC';
        $orderby = isset($orderby) && in_array(strtolower($orderby), array(
            'price',
            'num'
        )) ? strtolower($orderby) : '';
