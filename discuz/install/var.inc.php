...
define('DBCHARSET', ! $dbcharset && in_array(strtolower($charset), array(
    'gbk',
    'big5',
    'utf-8'
)) ? str_replace('-', '', $charset) : $dbcharset);
...
$dirfile_items = array(
    ...
    'cache' => array(
        'type' => 'dir',
        'path' => './forumdata/cache'
    ),
    'ftemplates' => array(
        'type' => 'dir',
        'path' => './forumdata/templates'
    ),
    'threadcache' => array(
        'type' => 'dir',
        'path' => './forumdata/threadcaches'
    ),
    'logs' => array(
        'type' => 'dir',
        'path' => './forumdata/logs'
