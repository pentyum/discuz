...
if ($requestrun) {
    ...
    $request_settings = array(
        'type' => array(
            $requestlang['html_type'],
            $requestlang['html_type_comment'],
            'select',
            array(
                array(
                    '0',
                    $requestlang['html_type_html']
                ),
                array(
                    '1',
                    $requestlang['html_type_code']
                )
            )
        ),
        'code' => array(
            $requestlang['html_code'],
            $requestlang['html_code_comment'],
            'textarea'
        ),
        'side' => array(
            $requestlang['html_side'],
            $requestlang['html_side_comment'],
            'radio'
        )
    );
}
