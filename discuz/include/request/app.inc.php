...
if ($requestrun) {
    ...
    $request_settings = array(
        'title' => array(
            $requestlang['app_title'],
            $requestlang['app_title_comment'],
            'text',
            '',
            $requestlang['app_title_value']
        ),
        'uid' => array(
            $requestlang['app_uids'],
            $requestlang['app_uids_comment'],
            'text'
        ),
        'type' => array(
            $requestlang['app_type'],
            '',
            'mradio',
            array(
                array(
                    '0',
                    $requestlang['app_type_nolimit']
                ),
                array(
                    '1',
                    $requestlang['app_type_default']
                ),
                array(
                    '2',
                    $requestlang['app_type_userapp']
                )
            ),
            '0'
        ),
        'start' => array(
            $requestlang['app_start'],
            $requestlang['app_start_comment'],
            'text',
            '',
            '0'
        ),
        'limit' => array(
            $requestlang['app_limit'],
            $requestlang['app_limit_comment'],
            'text',
            '',
            '10'
        ),
        'template' => array(
            $requestlang['app_template'],
            $requestlang['app_template_comment'],
            'textarea',
            '',
            '<img src="{icon}"><a href="{link}">{appname}</a>'
        )
    );
}
