...
if ($requestrun) {
    ...
    $request_settings = array(
        'lang' => array(
            $requestlang['google_lang'],
            $requestlang['google_lang_comment'],
            'mradio',
            array(
                array(
                    '',
                    $requestlang['google_lang_any']
                ),
                array(
                    'en',
                    $requestlang['google_lang_en']
                ),
                array(
                    'zh-CN',
                    $requestlang['google_lang_zh-CN']
                ),
                array(
                    'zh-TW',
                    $requestlang['google_lang_zh-TW']
                )
            )
        ),
        'default' => array(
            $requestlang['google_default'],
            $requestlang['google_default_comment'],
            'mradio',
            array(
                array(
                    0,
                    $requestlang['google_default_0']
                ),
                array(
                    1,
                    $requestlang['google_default_1']
                )
            )
        )
    );
