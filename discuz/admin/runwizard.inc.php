...
if ($step == 1) {
    ...
    showtableheader();
    showsetting('runwizard_forum_scope', array(
        'size',
        array(
            array(
                0,
                $lang['runwizard_forum_scope_small']
            ),
            array(
                1,
                $lang['runwizard_forum_scope_midding']
            ),
            array(
                2,
                $lang['runwizard_forum_scope_big']
            )
        )
    ), $sizecheckedid, 'mradio');
    showsetting('runwizard_security', array(
        'safe',
        array(
            array(
                2,
                $lang['runwizard_security_high']
            ),
            array(
                1,
                $lang['runwizard_security_midding']
            ),
            array(
                0,
                $lang['runwizard_security_low']
            )
        )
    ), $safecheckedid, 'mradio');
    showsetting('runwizard_hobby', array(
        'func',
        array(
            array(
                0,
                $lang['runwizard_hobby_concision']
            ),
            array(
                1,
                $lang['runwizard_hobby_commonly']
            ),
            array(
                2,
                $lang['runwizard_hobby_abundance']
            )
        )
...
<?
        ...
        $sizesettings = array(
            ...
            'maxmodworksmonths' => array(
                '5',
                '3',
                '1'
            ),
            'maxsearchresults' => array(
                '200',
                '500',
                '1000'
            ),
            'statscachelife' => array(
                '90',
                '180',
                '360'
            ),
        ...
        $safesettings = array(
            'attachrefcheck' => array(
                '',
                '1',
                '1'
            ),
            'bannedmessages' => array(
                '',
                '1',
                '1'
            ),
        ...
        $funcsettings = array(
            ...
            'subforumsindex' => array(
                '0',
                '0',
                '1'
            ),
            'transsidstatus' => array(
                '0',
                '0',
                '1'
            ),
        ...
        $funcforums = array(
            ...
            'allowpostspecial' => array(
                '',
                '1',
                '127'
            ),
            'disablewatermark' => array(
                '1',
                '0',
                '0'
            ),
