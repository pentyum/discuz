...
<?
        ...
        $table_forumfield_columns = array(
            'fid',
            'attachextensions',
            'threadtypes',
            'postcredits',
    ...
    if (! submitcheck('detailsubmit') && ! submitcheck('saveconfigsubmit')) {
        ...
        $forumselect = '<span id="fselect" class="right popupmenu_dropmenu" onmouseover="showMenu({\'ctrlid\':this.id,\'pos\':\'34\'});$(\'fselect_menu\').style.top=(parseInt($(\'fselect_menu\').style.top)-document.documentElement.scrollTop)+\'px\'">' . $lang['forums_edit_switch'] . '<em>&nbsp;&nbsp;</em></span>' . '<div id="fselect_menu" class="popupmenu_popup" style="width:200px;display:none">' . $forumselect . '</div>';
        ...
        if ($forum['type'] == 'group') {
            ...
            showsubmenuanchors(lang('forums_edit') . ' - ' . $forum['name'], array(
                ...
                array(
                    'forums_edit_threadtypes',
                    'threadtypes',
                    $anchor == 'threadtypes'
                ),
                array(
                    'forums_edit_threadsorts',
                    'threadsorts',
                    $anchor == 'threadsorts'
                ),
                array(
        ...
        if ($forum['type'] == 'group') {
            ...
            while ($style = $db->fetch_array($query)) {
                $styleselect .= "<option value=\"$style[styleid]\" " . ($style['styleid'] == $forum['styleid'] ? 'selected="selected"' : NULL) . ">$style[name]</option>\n";
            }
            $styleselect .= '</select>';
            ...
            while ($type = $db->fetch_array($query)) {
                ...
                if (! $type['special']) {
                    ...
                    $sortselect .= $showtype ? showtablerow('', array(
                        'class="td25"'
                    ), array(
            ...
            $typeselect = $typeselect ? $typeselect : showtablerow('', array(
                'class="td25"'
            ), $lang['forums_edit_threadtypes_nonexistence'], TRUE);
            $sortselect = $sortselect ? $sortselect : showtablerow('', array(
                'class="td25"'
            ), $lang['forums_edit_threadsorts_nonexistence'], TRUE);
            ...
            showsetting('forums_edit_basic_display', array(
                'statusnew',
                array(
                    array(
                        1,
                        $lang['forums_edit_basic_display_yes']
                    ),
                    array(
                        0,
                        $lang['forums_edit_basic_display_no']
                    ),
                    array(
                        2,
                        $lang['forums_edit_basic_display_select']
                    )
                )
            ), $forum['status'], 'mradio');
            ...
            showsetting('forums_edit_extend_sub_horizontal', 'forumcolumnsnew', $forum['forumcolumns'], 'text');
            showsetting('forums_edit_extend_subforumsindex', array(
                'subforumsindexnew',
                array(
                    array(
                        - 1,
            ...
            showsetting('forums_edit_extend_defaultorderfield', array(
                'defaultorderfieldnew',
                array(
                    array(
                        0,
                        $lang['forums_edit_extend_order_lastpost']
                    ),
                    array(
                        1,
                        $lang['forums_edit_extend_order_starttime']
                    ),
                    array(
                        2,
                        $lang['forums_edit_extend_order_replies']
                    ),
                    array(
                        3,
                        $lang['forums_edit_extend_order_views']
                    )
                )
            ), $forum['defaultorderfield'], 'mradio');
            showsetting('forums_edit_extend_defaultorder', array(
                'defaultordernew',
                array(
                    array(
                        0,
                        $lang['forums_edit_extend_order_desc']
                    ),
                    array(
                        1,
                        $lang['forums_edit_extend_order_asc']
                    )
                )
            ...
            showsetting('forums_edit_extend_recommend_sort', array(
                'modrecommendnew[sort]',
                array(
                    array(
                        1,
                        $lang['forums_edit_extend_recommend_sort_auto']
                    ),
                    array(
                        0,
                        $lang['forums_edit_extend_recommend_sort_manual']
                    ),
                    array(
                        2,
                        $lang['forums_edit_extend_recommend_sort_mix']
                    )
                )
            ), $forum['modrecommend']['sort'], 'mradio');
            showsetting('forums_edit_extend_recommend_orderby', array(
                'modrecommendnew[orderby]',
                array(
                    array(
                        0,
                        $lang['forums_edit_extend_recommend_orderby_dateline']
                    ),
                    array(
                        1,
                        $lang['forums_edit_extend_recommend_orderby_lastpost']
                    ),
                    array(
                        2,
                        $lang['forums_edit_extend_recommend_orderby_views']
                    ),
                    array(
                        3,
                        $lang['forums_edit_extend_recommend_orderby_replies']
                    ),
                    array(
                        4,
                        $lang['forums_edit_extend_recommend_orderby_digest']
                    ),
                    array(
                        5,
                        $lang['forums_edit_extend_recommend_orderby_recommend']
                    ),
                    array(
                        6,
                        $lang['forums_edit_extend_recommend_orderby_heats']
                    )
                )
            ...
            showsetting('forums_edit_extend_recommend_imagesize', array(
                'modrecommendnew[imagewidth]',
                'modrecommendnew[imageheight]'
            ), array(
                intval($forum['modrecommend']['imagewidth']),
                intval($forum['modrecommend']['imageheight'])
            ), 'multiply');
            ...
            showsetting('forums_edit_posts_modposts', array(
                'modnewpostsnew',
                array(
                    array(
                        0,
                    ...
                    array(
                        1,
                        $lang['forums_edit_posts_modposts_threads']
                    ),
                    array(
                        2,
                        $lang['forums_edit_posts_modposts_posts']
                    )
                )
            ...
            if ($tagstatus) {
                showsetting('forums_edit_posts_tagstatus', array(
                    'allowtagnew',
                    array(
                        array(
                            0,
                            $lang['forums_edit_posts_tagstatus_none']
                        ),
                        array(
                            1,
                            $lang['forums_edit_posts_tagstatus_use']
                        ),
                        array(
                            2,
                            $lang['forums_edit_posts_tagstatus_quired']
                        )
                    )
                ), $forum['allowtag'], 'mradio');
            }
            
            showsetting('forums_edit_posts_allowpostspecial', array(
                'allowpostspecialnew',
                array(
                    $lang['thread_poll'],
                    $lang['thread_trade'],
            ...
            if ($threadpluginarray) {
                showsetting('forums_edit_posts_threadplugin', array(
                    'threadpluginnew',
                    $threadpluginarray
                ), $forum['threadplugin'], 'mcheckbox');
            }
            ...
            if (! empty($tradetypes) && is_array($tradetypes)) {
                ...
                showsetting('forums_edit_posts_trade_type', array(
                    'tradetypesnew',
                    $tradetypearray
                ), $forum['tradetypes'], 'mcheckbox');
            }
            showsetting('forums_edit_posts_autoclose', array(
                'autoclosenew',
                array(
                    array(
                        0,
                        $lang['forums_edit_posts_autoclose_none'],
                        array(
                            'autoclose_time' => 'none'
                        )
                    ),
                    array(
                        1,
                        $lang['forums_edit_posts_autoclose_dateline'],
                        array(
                            'autoclose_time' => ''
                        )
                    ),
                    array(
                        - 1,
                        $lang['forums_edit_posts_autoclose_lastpost'],
                        array(
                            'autoclose_time' => ''
                        )
                    )
...
EOT;
                ...
                showsetting('forums_edit_threadtypes_status', array(
                    'threadtypesnew[status]',
                    array(
                        array(
                            1,
                            $lang['yes'],
                        ...
                        array(
                            ...
                            $lang['no'],
                            array(
                                'threadtypes_config' => 'none',
                                'threadtypes_manage' => 'none'
                            )
                        )
                    ),
                    TRUE
                ), $forum['threadtypes']['status'], 'mradio');
                ...
                showsubtitle(array(
                    'enable',
                    'forums_edit_threadtypes_name',
                    'forums_edit_threadtypes_note',
                    'forums_edit_threadtypes_showtype',
                    'forums_edit_threadtypes_show'
                ));
                echo $typeselect;
                ...
                showsetting('forums_edit_threadsorts_status', array(
                    'threadsortsnew[status]',
                    array(
                        array(
                            1,
                            $lang['yes'],
                        ...
                        array(
                            ...
                            $lang['no'],
                            array(
                                'threadsorts_config' => 'none',
                                'threadsorts_manage' => 'none'
                            )
                        )
                    ),
                    TRUE
                ), $forum['threadsorts']['status'], 'mradio');
                ...
                showsubtitle(array(
                    ...
                    'forums_edit_threadtypes_showtype',
                    'forums_edit_threadtypes_show',
                    'forums_edit_threadtypes_defaultshow'
                ));
                echo $sortselect;
                showtablefooter();
                showtagfooter('div');
            ...
            showsetting('forums_edit_perm_medal', array(
                'medalnew',
                $colums
            ), $forum['medal'], 'mcheckbox');
            showtagfooter('tbody');
            showtablefooter();
            ...
            foreach (array(
                ...
                showtablerow('', '', array(
                    '<b>' . $lang['usergroups_' . $type] . '</b>'
                ));
                foreach ($tgroups as $group) {
                    $colums = array(
                        '<input class="checkbox" title="' . $lang['select_all'] . '" type="checkbox" name="chkallv' . $group['groupid'] . '" onclick="checkAll(\'value\', this.form, ' . $group['groupid'] . ', \'chkallv' . $group['groupid'] . '\')" id="chkallv_' . $group['groupid'] . '" /><label for="chkallv_' . $group['groupid'] . '"> ' . $group['grouptitle'] . '</label>'
                    );
...
<tr>
	<td colspan="2"><div class="extcredits">
...
<a href="###" onclick="insertunit(' regdate ')">&nbsp;<?php echo lang('forums_edit_perm_formula_regdate')?>&nbsp;</a>&nbsp;
			...
			<a href="###" onclick="insertunit(' + ')">&nbsp;+&nbsp;</a>&nbsp; <a
				href="###" onclick="insertunit(' - ')">&nbsp;-&nbsp;</a>&nbsp; <a
				href="###" onclick="insertunit(' * ')">&nbsp;*&nbsp;</a>&nbsp; <a
				href="###" onclick="insertunit(' / ')">&nbsp;/&nbsp;</a>&nbsp; <a
				href="###" onclick="insertunit(' > ')">&nbsp;>&nbsp;</a>&nbsp; <a
				href="###" onclick="insertunit(' >= ')">&nbsp;>=&nbsp;</a>&nbsp; <a
		...
		</div> <textarea name="formulapermnew" id="formulapermnew"
			class="marginbot" style="width: 80%" rows="3" onkeyup="formulaexp()"><?php echo dhtmlspecialchars($forum['formulaperm'])?></textarea>
		<script type="text/JavaScript">formulaexp()</script> <br />
	<span class="smalltxt"><?=$lang['forums_edit_perm_formula_comment']?></span>
...
<?php
        ...
        if ($formulapermnew && ! preg_match("/^(\{|\}|\+|\-|\*|\/|\.|>|<|=|!|\d|\s|\(|\)|extcredits[1-8]|regdate|regday|regip|lastip|buyercredit|sellercredit|field\_\d+|digestposts|posts|threads|pageviews|oltime|and|or)+$/", $formulapermnew) || ! is_null(@eval(preg_replace(array(
            "/(regdate|regday|regip|lastip|buyercredit|sellercredit|field\_\d+|digestposts|posts|threads|pageviews|oltime|extcredits[1-8])/",
            "/\{([\d\.\-]+?)\}/"
        ), array(
            "\$\\1",
            "'\\1'"
        ...
        $formulapermary[1] = preg_replace(array(
            "/(digestposts|posts|threads|pageviews|oltime|extcredits[1-8])/",
            "/(regdate|regday|regip|lastip|buyercredit|sellercredit|field\_\d+)/"
        ), array(
            "\$_DSESSION['\\1']",
            "\$memberformula['\\1']"
        ), $formulapermnew);
...
function showforum($key, $type = '', $last = '')
{
    ...
    if ($last == '') {
        ...
        $return .= '<input type="text" name="name[' . $forum['fid'] . ']" value="' . htmlspecialchars($forum['name']) . '" class="txt" />' . ($type == '' ? '<a href="###" onclick="addrowdirect = 1;addrow(this, 2, ' . $forum['fid'] . ')" class="addchildboard">' . $lang['forums_admin_add_sub'] . '</a>' : '') . '</div>' . $boardattr . '</td><td>' . showforum_moderators($forum) . '</td>
			<td><a href="' . $BASESCRIPT . '?action=forums&operation=edit&fid=' . $forum['fid'] . '" title="' . $lang['forums_edit_comment'] . '" class="act">' . $lang['edit'] . '</a>' . ($type != 'group' ? '<a href="' . $BASESCRIPT . '?action=forums&operation=copy&source=' . $forum['fid'] . '" title="' . $lang['forums_copy_comment'] . '" class="act">' . $lang['forums_copy'] . '</a>' : '') . '<a href="' . $BASESCRIPT . '?action=forums&operation=delete&fid=' . $forum['fid'] . '" title="' . $lang['forums_delete_comment'] . '" class="act">' . $lang['delete'] . '</a></td></tr>';
    } else {
        if ($last == 'lastboard') {
