...
if (! $operation) {
    ...
    if (! submitcheck('medalsubmit')) {
        ...
        showsubmenu('nav_medals', array(
            ...
            array(
                'nav_medals_confer',
                'members&operation=confermedal',
                0
            ),
            array(
                'nav_medals_mod',
                'medals&operation=mod',
                0
            )
        ));
...
<a href="###" onclick="insertunit(' regdate ')">&nbsp;<?php echo lang('forums_edit_perm_formula_regdate')?>&nbsp;</a>&nbsp;
		...
		<div id="formulapermexp" class="marginbot diffcolor2"><?=$formulapermexp?></div>
		<textarea name="formulapermnew" id="formulapermnew" style="width: 80%"
			rows="3" onkeyup="formulaexp()"><?=dhtmlspecialchars($medal['permission'])?></textarea>
		<br />
	<span class="smalltxt"><?=$lang['medals_permformula']?></span> <br /><?=$lang['creditwizard_current_formula_notice']?>
<script type="text/JavaScript">formulaexp()</script></td>
</tr>
<?
