...
if ($operation == 'admin') {
    ...
    if (! submitcheck('magicsubmit')) {
        ...
        showsubmenu('nav_magics', array(
            ...
            array(
                'admin',
                'magics&operation=admin',
                1
            ),
            array(
                'nav_magics_market',
                'magics&operation=market',
                0
            )
        ));
...
EOT;
    ...
    if (! submitcheck('magiceditsubmit')) {
        ...
        showsetting('magics_edit_supplytype', array(
            'supplytypenew',
            array(
                array(
                    0,
                    $lang['magics_goods_stack_none']
                ),
                array(
                    1,
                    $lang['magics_goods_stack_day']
                ),
                array(
                    2,
                    $lang['magics_goods_stack_week']
                ),
                array(
                    3,
                    $lang['magics_goods_stack_month']
                )
            )
        ...
        if ($typenew == 4) {
            ...
            if (is_array($magiccontent)) {
                foreach ($magiccontent as $id => $val) {
                    ...
                    $magicperm['presentcontent'][$id] = array(
                        'num' => $num,
                        'weight' => $weight[$id]
                    );
                }
