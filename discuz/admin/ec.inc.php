...
if ($operation == 'alipay') {
    ...
    if (! submitcheck('alipaysubmit')) {
        ...
        showsetting('ec_alipay_check', '', '', '<a href="' . $BASESCRIPT . '?action=ec&operation=alipay&checktype=credit" target="_blank">' . $lang['ec_alipay_checklink_credit'] . '</a><br />' . '<a href="' . $BASESCRIPT . '?action=ec&operation=alipay&checktype=virtualgoods" target="_blank">' . $lang['ec_alipay_checklink_virtualgoods'] . '</a><br />' . '<a href="' . $BASESCRIPT . '?action=ec&operation=alipay&checktype=goods" target="_blank">' . $lang['ec_alipay_checklink_goods'] . '</a><br />');
    ...
    if (! submitcheck('tenpaysubmit')) {
        ...
        showsetting('ec_tenpay_check', '', '', '<a href="' . $BASESCRIPT . '?action=ec&operation=tenpay&checktype=credit" target="_blank">' . $lang['ec_alipay_checklink_credit'] . '</a><br />');
        showtablefooter();
    ...
    if (! submitcheck('ordersubmit')) {
        ...
        showsetting('ec_orders_search_status', array(
            'orderstatus',
            array(
                array(
                    '',
                ...
                array(
                    1,
                    $lang['ec_orders_search_status_pending']
                ),
                array(
                    2,
                    $lang['ec_orders_search_status_auto_finished']
                ),
                array(
                    3,
                    $lang['ec_orders_search_status_manual_finished']
                )
            )
        ...
        showsetting('ec_orders_search_submit_date', array(
            'sstarttime',
            'sendtime'
        ), array(
            $sstarttime,
        ...
        showsetting('ec_orders_search_confirm_date', array(
            'cstarttime',
            'cendtime'
        ), array(
            $cstarttime,
            ...
            while ($order = $db->fetch_array($query)) {
                switch ($order['status']) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        $order['orderstatus'] = '<b>' . $lang['ec_orders_search_status_manual_finished'] . '</b><br />(<a href="space.php?username=' . rawurlencode($order['admin']) . '" target="_blank">' . $order['admin'] . '</a>)';
                        break;
                }
