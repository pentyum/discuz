...
EOT;
    ...
    showsetting('threads_search_time', array(
        'starttime',
        'endtime'
    ), array(
        $starttime,
    ...
    showsetting('threads_search_viewrange', array(
        'viewsmore',
        'viewsless'
    ), array(
        $viewsmore,
    ...
    showsetting('threads_search_replyrange', array(
        'repliesmore',
        'repliesless'
    ), array(
        $repliesmore,
    ...
    showsetting('threads_search_type', array(
        'specialthread',
        array(
            array(
                0,
            ...
            array(
                1,
                lang('threads_search_include_yes'),
                array(
                    'showspecial' => ''
                )
            ),
            array(
                2,
                lang('threads_search_include_no'),
                array(
                    'showspecial' => ''
                )
            )
    ...
    ), $special ? $special : array(
        0
    )));
    showsetting('threads_search_sticky', array(
        'sticky',
        array(
            array(
                0,
    ...
    showsetting('threads_search_digest', array(
        'digest',
        array(
            array(
                0,
    ...
    showsetting('threads_search_attach', array(
        'attach',
        array(
            array(
                0,
    ...
    showsetting('threads_rate', array(
        'rate',
        array(
            array(
                0,
    ...
    showsetting('threads_highlight', array(
        'highlight',
        array(
            array(
                0,
    ...
    if (submitcheck('searchsubmit')) {
        ...
        if (! $threadcount) {
            ...
            showtablerow('', array(
                'class="td25"',
                'class="td24"',
                'class="rowform" style="width:auto;"'
            ), array(
    ...
    if ($operation == 'moveforum') {
        ...
        if (! submitcheck('forumsticksubmit')) {
            showsubmenu('threads_forumstick', array(
                ...
                array(
                    'add',
                    'threads&operation=forumstick&do=add',
                    $do == 'add'
                )
            ));
        ...
        if (! $do) {
            if (submitcheck('delpositionsubmit')) {
                ...
                showsubmenu('threads_postposition', array(
                    ...
                    array(
                        'add',
                        'threads&operation=postposition&do=add',
                        $do == 'add'
                    )
                ));
