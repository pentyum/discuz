...
if ($operation == 'styles') {
    ...
    foreach ($floatwinkeys as $k) {
        $floatwinarray[] = array(
            $k,
            $lang['settings_styles_global_allowfloatwin_' . $k]
        );
    }
}
...
if (! submitcheck('settingsubmit')) {
    ...
    if (in_array($operation, array(
        ...
        showsubmenu('settings_optimize', array(
            array(
                'settings_seo',
                'settings&operation=seo',
                $current['seo']
            ),
            array(
                'settings_cachethread',
                'settings&operation=cachethread',
                $current['cachethread']
            ),
            array(
                'settings_serveropti',
                'settings&operation=serveropti',
                $current['serveropti']
            )
        ));
    } elseif ($operation == 'ec') {
        if ($from == 'creditwizard') {
            showsubmenu('nav_creditwizard', array(
                array(
                    'creditwizard_step_menu_1',
                    'creditwizard&step=1',
                    0
                ),
                array(
                    'creditwizard_step_menu_2',
                    'creditwizard&step=2',
                    0
                ),
                array(
                    'creditwizard_step_menu_3',
                    'creditwizard&step=3',
                    0
                ),
                array(
                    'creditwizard_step_menu_4',
                    'settings&operation=ec&from=creditwizard',
                    1
                ),
                array(
                    'ec_alipay',
                    'ec&operation=alipay&from=creditwizard',
                    0
                ),
                array(
                    'ec_tenpay',
                    'ec&operation=tenpay&from=creditwizard',
                    0
                )
            ));
        } else {
        ...
        $anchor = in_array($anchor, array(
            'register',
            'access'
        )) ? $anchor : 'register';
        showsubmenuanchors('settings_access', array(
            array(
                'settings_access_register',
                'register',
                $anchor == 'register'
            ),
            array(
                'settings_access_access',
                'access',
                $anchor == 'access'
            )
        ));
        ...
        showsubmenuanchors('settings_sec', array(
            array(
                'settings_sec_seclevel',
                'seclevel',
                $anchor == 'seclevel'
            ),
            array(
                'settings_sec_seccode',
                'seccode',
                $anchor == 'seccode'
            ),
            array(
        ...
        showsubmenuanchors('settings_attach', array(
            array(
                'settings_attach_basic',
                'basic',
                $anchor == 'basic'
            ),
            array(
                'settings_attach_image',
                'image',
                $anchor == 'image'
            ),
            $isfounder ? array(
                'settings_attach_remote',
                'remote',
                $anchor == 'remote'
            ) : '',
            array(
                'settings_attach_antileech',
                'antileech',
                $anchor == 'antileech'
            )
        ));
        ...
        showsubmenu('settings_styles', array(
            array(
                'settings_styles_global',
                'settings&operation=styles&anchor=global',
                $current['global']
            ),
            array(
                'settings_styles_index',
                'settings&operation=styles&anchor=index',
                $current['index']
            ),
            array(
                'settings_styles_forumdisplay',
                'settings&operation=styles&anchor=forumdisplay',
                $current['forumdisplay']
            ),
            array(
                'settings_styles_viewthread',
                'settings&operation=styles&anchor=viewthread',
                $current['viewthread']
            ),
            array(
                'settings_styles_member',
                'settings&operation=styles&anchor=member',
                $current['member']
            ),
            array(
                'settings_styles_customnav',
                'misc&operation=customnav',
                0
            ),
            array(
                array(
                    'menu' => 'jswizard_infoside',
                    'submenu' => array(
                        array(
                            'jswizard_infoside_global',
                            'jswizard&operation=infoside&from=style'
                        ),
                        array(
                            'jswizard_infoside_2',
                            'jswizard&operation=infoside&sideid=2&from=style'
                        ),
                        array(
                            'jswizard_infoside_0',
                            'jswizard&operation=infoside&sideid=0&from=style'
                        )
                    )
                )
            ),
            array(
                'settings_styles_refresh',
                'settings&operation=styles&anchor=refresh',
                $current['refresh']
            ),
            array(
                'settings_styles_sitemessage',
                'settings&operation=styles&anchor=sitemessage',
                $current['sitemessage']
            )
        ));
        ...
        showsubmenuanchors('settings_functions', array(
            array(
                'settings_functions_stat',
                'stat',
                $anchor == 'stat'
            ),
            array(
                'settings_functions_mod',
                'mod',
                $anchor == 'mod'
            ),
            array(
                'settings_functions_tags',
                'tags',
                $anchor == 'tags'
            ),
            array(
                'settings_functions_heatthread',
                'heatthread',
                $anchor == 'heatthread'
            ),
            array(
                'settings_functions_recommend',
                'recommend',
                $anchor == 'recommend'
            ),
            array(
                'settings_functions_other',
                'other',
                $anchor == 'other'
            )
        ));
        ...
        showsubmenu('settings_editor', array(
            array(
                'settings_editor_global',
                'settings&operation=editor',
                1
            ),
            array(
                'settings_editor_code',
                'misc&operation=bbcode',
                0
            )
        ));
    ...
    if ($operation == 'basic') {
        ...
        showsetting('settings_access_register_status', array(
            'settingsnew[regstatus]',
            array(
                array(
                    0,
                    $lang['settings_access_register_close'],
                    array(
                        'showinvite' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_access_register_open'],
                    array(
                        'showinvite' => 'none'
                    )
                ),
                array(
                    2,
                    $lang['settings_access_register_invite'],
                    array(
                        'showinvite' => ''
                    )
                ),
                array(
                    3,
                    $lang['settings_access_register_open_invite'],
                    array(
                        'showinvite' => ''
                    )
                )
        ...
        showsetting('settings_access_register_verify', array(
            'settingsnew[regverify]',
            array(
                array(
                    0,
                    $lang['none']
                ...
                array(
                    1,
                    $lang['settings_access_register_verify_email']
                ),
                array(
                    2,
                    $lang['settings_access_register_verify_manual']
                )
            )
        ...
        showsetting('settings_access_register_welcomemsg', array(
            'settingsnew[welcomemsg]',
            array(
                array(
                    0,
                    $lang['settings_access_register_welcomemsg_nosend'],
                    array(
                        'welcomemsgext' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_access_register_welcomemsg_pm'],
                    array(
                        'welcomemsgext' => ''
                    )
                ),
                array(
                    2,
                    $lang['settings_access_register_welcomemsg_email'],
                    array(
                        'welcomemsgext' => ''
                    )
                )
        ...
        showsetting('settings_styles_global_frameon', array(
            'settingsnew[frameon]',
            array(
                array(
                    0,
                    $lang['settings_styles_global_frameon_0'],
                    array(
                        'frameonext' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_styles_global_frameon_1'],
                    array(
                        'frameonext' => ''
                    )
                ),
                array(
                    2,
                    $lang['settings_styles_global_frameon_2'],
                    array(
                        'frameonext' => ''
                    )
                )
        ...
        showtagfooter('tbody');
        showsetting('settings_styles_global_allowfloatwin', array(
            'settingsnew[allowfloatwin]',
            $floatwinarray
        ), $settings['allowfloatwin'], 'mcheckbox');
        ...
        showsetting('settings_styles_index_indextype', array(
            'settingsnew[indextype]',
            array(
                array(
                    'classics',
                    $lang['settings_styles_index_indextype_classics']
                ),
                array(
                    'feeds',
                    $lang['settings_styles_index_indextype_feeds']
                )
            )
        ...
        showsetting('settings_styles_index_moddisplay', array(
            'settingsnew[moddisplay]',
            array(
                array(
                    'flat',
                    $lang['settings_styles_index_moddisplay_flat']
                ),
                array(
                    'selectbox',
                    $lang['settings_styles_index_moddisplay_selectbox']
                )
            )
        ), $settings['moddisplay'], 'mradio');
        showsetting('settings_styles_index_whosonline', array(
            'settingsnew[whosonlinestatus]',
            array(
                array(
                    0,
                    $lang['settings_styles_index_display_none']
                ),
                array(
                    1,
                    $lang['settings_styles_index_whosonline_index']
                ),
                array(
                    2,
                    $lang['settings_styles_index_whosonline_forum']
                ),
                array(
                    3,
                    $lang['settings_styles_index_whosonline_both']
                )
            )
        ...
        showsetting('settings_styles_viewthread_vtonlinestatus', array(
            'settingsnew[vtonlinestatus]',
            array(
                array(
                    0,
                    $lang['settings_styles_viewthread_display_none']
                ),
                array(
                    1,
                    $lang['settings_styles_viewthread_online_easy']
                ),
                array(
                    2,
                    $lang['settings_styles_viewthread_online_exactitude']
                )
            )
        ), $settings['vtonlinestatus'], 'select');
        showsetting('settings_styles_viewthread_userstatusby', array(
            'settingsnew[userstatusby]',
            array(
                array(
                    0,
                    $lang['settings_styles_viewthread_display_none']
                ...
                array(
                    1,
                    $lang['settings_styles_viewthread_userstatusby_usergroup']
                ),
                array(
                    2,
                    $lang['settings_styles_viewthread_userstatusby_rank']
                )
            )
        ...
        showsetting('settings_styles_viewthread_author_onleft', array(
            'settingsnew[authoronleft]',
            array(
                array(
                    1,
                    lang('settings_styles_viewthread_author_onleft_yes')
                ),
                array(
                    0,
                    lang('settings_styles_viewthread_author_onleft_no')
                )
            )
        ), $settings['authoronleft'], 'mradio');
        ...
        showsubtitle(array(
            '',
            'settings_styles_viewthread_userinfo_left',
            'settings_styles_viewthread_userinfo_menu'
        ));
        
        $authorinfoitemsetting = '';
        foreach ($authorinfoitems as $key => $value) {
            $authorinfoitemsetting .= '<tr><td>' . $value . '</td><td><input name="settingsnew[customauthorinfo][' . $key . '][left]" type="checkbox" class="checkbox" value="1" ' . ($settings['customauthorinfo'][$key]['left'] ? 'checked' : '') . '>' . '</td><td><input name="settingsnew[customauthorinfo][' . $key . '][menu]" type="checkbox" class="checkbox" value="1" ' . ($settings['customauthorinfo'][$key]['menu'] ? 'checked' : '') . '>' . '</td></tr>';
        }
        ...
        showsetting('settings_seo_archiverstatus', array(
            'settingsnew[archiverstatus]',
            array(
                array(
                    0,
                    $lang['settings_seo_archiverstatus_none']
                ),
                array(
                    1,
                    $lang['settings_seo_archiverstatus_full']
                ),
                array(
                    2,
                    $lang['settings_seo_archiverstatus_searchengine']
                ),
                array(
                    3,
                    $lang['settings_seo_archiverstatus_browser']
                )
            )
        ), $settings['archiverstatus'], 'mradio');
        showsetting('settings_seo_rewritestatus', array(
            'settingsnew[rewritestatus]',
            array(
                ...
                $lang['settings_seo_rewritestatus_archiver']
            )
        ), $settings['rewritestatus'], 'binmcheckbox');
        ...
        showsetting('settings_serveropti_delayviewcount', array(
            'settingsnew[delayviewcount]',
            array(
                array(
                    0,
                    lang('none')
                ...
                array(
                    1,
                    lang('settings_serveropti_delayviewcount_thread')
                ),
                array(
                    2,
                    lang('settings_serveropti_delayviewcount_attach')
                ),
                array(
                    3,
                    lang('settings_serveropti_delayviewcount_thread_attach')
                )
            )
        ...
        showtableheader();
        showsetting('settings_editor_mode_default', array(
            'settingsnew[defaulteditormode]',
            array(
                array(
                    0,
                    $lang['settings_editor_mode_discuzcode']
                ),
                array(
                    1,
                    $lang['settings_editor_mode_wysiwyg']
                )
            )
        ), $settings['defaulteditormode'], 'mradio');
        ...
        showsetting('settings_functions_mod_bannedmessages', array(
            'settingsnew[bannedmessages]',
            array(
                $lang['settings_functions_mod_bannedmessages_thread'],
                $lang['settings_functions_mod_bannedmessages_avatar'],
                $lang['settings_functions_mod_bannedmessages_signature']
            )
        ), $settings['bannedmessages'], 'binmcheckbox');
        ...
        showsetting('settings_functions_tags_status', array(
            'settingsnew[tagstatus]',
            array(
                array(
                    0,
                    $lang['settings_functions_tags_status_none'],
                    array(
                        'tagext' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_functions_tags_status_use'],
                    array(
                        'tagext' => ''
                    )
                ),
                array(
                    2,
                    $lang['settings_functions_tags_status_quired'],
                    array(
                        'tagext' => ''
                    )
                )
        ...
        showsetting('settings_functions_recommend_defaultshow', array(
            'settingsnew[recommendthread][defaultshow]',
            array(
                array(
                    0,
                    $lang['settings_functions_recommend_defaultshow_0']
                ),
                array(
                    1,
                    $lang['settings_functions_recommend_defaultshow_1']
                )
            )
        ), $settings['recommendthread']['defaultshow'], 'mradio');
...
EOT;
        ...
        showsubtitle(array(
            'settings_credits_available',
            'credits_id',
            'credits_img',
            'credits_title',
            'credits_unit',
            'settings_credits_ratio',
            'settings_credits_init',
            'credits_inport',
            'credits_import'
        ), '');
        ...
        foreach (array(
            ...
            showtablerow('title="' . $lang['settings_credits_policy_' . $policy . '_comment'] . '"', array(
                'class="td22"',
                'class="td28"',
                'class="td28"',
                'class="td28"',
        ...
        showsetting('settings_mail_settings_send', array(
            'settingsnew[mail][mailsend]',
            array(
                array(
                    1,
                    $lang['settings_mail_settings_send_1'],
                    array(
                        'hidden1' => 'none',
                        'hidden2' => 'none'
                    )
                ...
                array(
                    2,
                    $lang['settings_mail_settings_send_2'],
                    array(
                        'hidden1' => '',
                        'hidden2' => ''
                    )
                ...
                array(
                    3,
                    $lang['settings_mail_settings_send_3'],
                    array(
                        'hidden1' => '',
                        'hidden2' => 'none'
                    )
        ...
        showtagfooter('tbody');
        showsetting('settings_mail_settings_delimiter', array(
            'settingsnew[mail][maildelimiter]',
            array(
                array(
                    1,
                    $lang['settings_mail_settings_delimiter_crlf']
                ),
                array(
                    0,
                    $lang['settings_mail_settings_delimiter_lf']
                ),
                array(
                    2,
                    $lang['settings_mail_settings_delimiter_cr']
                )
            )
        ), $settings['mail']['maildelimiter'], 'mradio');
        ...
        $seccodetypearray = array(
            array(
                0,
                lang('settings_sec_seccode_type_image'),
                array(
                    'seccodeimageext' => '',
                    'seccodeimagewh' => ''
                )
            ...
            array(
                1,
                lang('settings_sec_seccode_type_chnfont'),
                array(
                    'seccodeimageext' => '',
                    'seccodeimagewh' => ''
                )
            ...
            array(
                2,
                lang('settings_sec_seccode_type_flash'),
                array(
            ...
            array(
                3,
                lang('settings_sec_seccode_type_wav'),
                array(
                    'seccodeimageext' => 'none',
                    'seccodeimagewh' => 'none'
                )
        ...
        showsetting('settings_sec_seclevel', array(
            'settingsnew[seclevel]',
            array(
                array(
                    0,
                    $lang['settings_sec_seclevel_lower']
                ),
                array(
                    1,
                    $lang['settings_sec_seclevel_higher']
                )
            )
        ...
        showsetting('settings_sec_seccode_status', array(
            'settingsnew[seccodestatus]',
            array(
        ...
        showsetting('settings_sec_seccode_type', array(
            'settingsnew[seccodedata][type]',
            $seccodetypearray
        ), $settings['seccodedata']['type'], 'mradio');
...
EOT;
        ...
        showsetting('settings_sec_secqaa_status', array(
            'settingsnew[secqaa][status]',
            array(
                lang('settings_sec_seccode_status_register'),
                lang('settings_sec_seccode_status_post')
            )
        ...
        showsubtitle(array(
            '',
            'settings_sec_secqaa_question',
            'settings_sec_secqaa_answer'
        ));
        ...
        $checktimeformat = array(
            $settings['timeformat'] == 'H:i' ? 24 : 12 => 'checked'
        );
        ...
        showsetting('settings_attach_basic_save', array(
            'settingsnew[attachsave]',
            array(
                array(
                    0,
                    $lang['settings_attach_basic_save_default']
                ),
                array(
                    1,
                    $lang['settings_attach_basic_save_forum']
                ),
                array(
                    2,
                    $lang['settings_attach_basic_save_type']
                ),
                array(
                    3,
                    $lang['settings_attach_basic_save_month']
                ),
                array(
                    4,
                    $lang['settings_attach_basic_save_day']
                )
            )
        ), $settings['attachsave'], 'select', $checkmkdirfunc);
        $settings['swfupload'] = $settings['swfupload'] == 2 ? array(
            0,
            1
        ) : array(
            $settings['swfupload']
        );
        showsetting('settings_attach_basic_swfupload', array(
            'settingsnew[swfupload]',
            array(
                array(
                    0,
                    $lang['settings_attach_basic_simple']
                ),
                array(
                    1,
                    $lang['settings_attach_basic_multi']
                )
            )
        ), $settings['swfupload'], 'mcheckbox');
        ...
        showsetting('settings_attach_image_lib', array(
            'settingsnew[imagelib]',
            array(
                array(
                    0,
                    $lang['settings_attach_image_watermarktype_GD'],
                    array(
                        'imagelibext' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_attach_image_watermarktype_IM'],
                    array(
                        'imagelibext' => ''
                    )
                )
        ...
        showtagfooter('tbody');
        showsetting('settings_attach_image_thumbstatus', array(
            'settingsnew[thumbstatus]',
            array(
                array(
                    0,
                    $lang['settings_attach_image_thumbstatus_none'],
                    array(
                        'thumbext' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_attach_image_thumbstatus_add'],
                    array(
                        'thumbext' => ''
                    )
                ),
                array(
                    3,
                    $lang['settings_attach_image_thumbstatus_addfix'],
                    array(
                        'thumbext' => ''
                    )
                ),
                array(
                    2,
                    $lang['settings_attach_image_thumbstatus_replace'],
                    array(
                        'thumbext' => ''
                    )
                )
        ...
        showsetting('settings_attach_image_thumbwidthheight', array(
            'settingsnew[thumbwidth]',
            'settingsnew[thumbheight]'
        ), array(
            intval($settings['thumbwidth']),
            intval($settings['thumbheight'])
        ), 'multiply');
        showtagfooter('tbody');
        ...
        showsetting('settings_attach_image_watermarkminwidthheight', array(
            'settingsnew[watermarkminwidth]',
            'settingsnew[watermarkminheight]'
        ), array(
            intval($settings['watermarkminwidth']),
            intval($settings['watermarkminheight'])
        ), 'multiply');
        showsetting('settings_attach_image_watermarktype', array(
            'settingsnew[watermarktype]',
            array(
                array(
                    0,
                    $lang['settings_attach_image_watermarktype_gif'],
                    array(
                        'watermarktypeext' => 'none'
                    )
                ),
                array(
                    1,
                    $lang['settings_attach_image_watermarktype_png'],
                    array(
                        'watermarktypeext' => 'none'
                    )
                ),
                array(
                    2,
                    $lang['settings_attach_image_watermarktype_text'],
                    array(
                        'watermarktypeext' => ''
                    )
                )
        ...
        if ($isfounder) {
            ...
            showsetting('settings_attach_remote_enabled', array(
                'settingsnew[ftp][on]',
                array(
                    array(
                        1,
            ...
            showsetting('settings_attach_remote_mirror', array(
                'settingsnew[ftp][mirror]',
                array(
                    array(
                        1,
                        lang('settings_attach_remote_mirror_1')
                    ),
                    // array(2, lang('settings_attach_remote_mirror_2')),
                    array(
                        0,
                        lang('settings_attach_remote_mirror_0')
                    )
                )
        ...
        showsetting('settings_wap_charset', array(
            'settingsnew[wapcharset]',
            array(
                array(
                    1,
                    'UTF-8'
        ...
        showsetting('settings_dzfeed_user_usergroup', array(
            'settingsnew[dzfeed_limit][user_usergroup]',
            $usergroups_member
        ), $settings['dzfeed_limit']['user_usergroup'], 'mcheckbox');
        ...
        showsetting('settings_uc_connect', array(
            'settingsnew[uc][connect]',
            array(
                array(
                    'mysql',
                    $lang['settings_uc_connect_mysql'],
                    array(
                        'ucmysql' => ''
                    )
                ),
                array(
                    '',
                    $lang['settings_uc_connect_api'],
                    array(
                        'ucmysql' => 'none'
                    )
                )
            )
        ), UC_CONNECT, 'mradio', $disable);
        ...
        showsetting('settings_uc_avatarmethod', array(
            'settingsnew[avatarmethod]',
            array(
                array(
                    0,
                    $lang['settings_uc_avatarmethod_0']
                ),
                array(
                    1,
                    $lang['settings_uc_avatarmethod_1']
                )
            )
    ...
    if (isset($settingsnew['watermarktext'])) {
        ...
        $settingsnew['watermarktext']['fontpath'] = str_replace(array(
            '\\',
            '/'
        ), '', $settingsnew['watermarktext']['fontpath']);
    ...
    if ($operation == 'styles') {
        ...
        $settingsnew['customauthorinfo'] = addslashes(serialize(array(
            $settingsnew['customauthorinfo']
        )));
...
function creditsrow($policy)
{
    global $settings;
    $policyarray = array(
        lang('settings_credits_policy_' . $policy)
    );
    for ($i = 1; $i <= 8; $i ++) {
...
function dateformat($string, $operation = 'formalise')
{
    ...
    $replace = $operation == 'formalise' ? array(
        array(
            'n',
            'j',
            'y',
