...
if (! $operation) {
    ...
    if (! submitcheck('projectsubmit')) {
        ...
        while ($list = $db->fetch_array($query)) {
            ...
            $projectlist .= showtablerow('', array(
                'class="td25"',
                'class="td24"',
                'class="td26"',
                'class="td24"',
        ...
        showsubmenu('project_scheme', array(
            $allowforumsedit ? array(
                'project_forum_scheme',
                'project&type=forum',
                $type == 'forum'
            ) : array(),
            $allowusergroups ? array(
                'project_group_scheme',
                'project&type=group',
                $type == 'group'
            ) : array(),
            $allowcreditwizard ? array(
                'project_extcredit_scheme',
                'project&type=extcredit',
                $type == 'extcredit'
            ) : array(),
            array(
                'project_import_stick',
                'project&operation=import',
                $operation == 'import'
            )
        ));
    ...
    if (! submitcheck('addsubmit')) {
        ...
        if ($type == 'forum') {
            ...
            $delfields = array();
            $fieldoption = in_array('all', $fieldoption) ? array(
                1,
                2,
                3
            ) : $fieldoption;
