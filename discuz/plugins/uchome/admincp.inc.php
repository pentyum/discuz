...
if (! submitcheck('settingsubmit')) {
    ...
    if ($uchomeopen) {
        ...
        showsetting($scriptlang['uchome']['settings_uc_feed'], array(
            'settingsnew[uchome][addfeed]',
            array(
                $scriptlang['uchome']['settings_uc_feed_thread'],
                $scriptlang['uchome']['settings_uc_feed_sepcialthread'],
                $scriptlang['uchome']['settings_uc_feed_reply']
            )
        ), $settings['uchome']['addfeed'], 'binmcheckbox', 0, '', $scriptlang['uchome']['settings_uc_feed_comment']);
        ...
        showsetting($scriptlang['uchome']['settings_uc_home_show'], array(
            'settingsnew[uchome][homeshow]',
            array(
                ...
                $scriptlang['uchome']['settings_uc_home_side']
            )
        ), $settings['uchome']['homeshow'], 'binmcheckbox', 0, '', $scriptlang['uchome']['settings_uc_home_show_comment']);
