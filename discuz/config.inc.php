...
define('UC_DBUSER', 'website');
define('UC_DBPW', 'stunion');
define('UC_DBNAME', 'website');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`website`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'laX9Xa4cK0S454v8B0A2pbL3Y0He99KcA6N6u3A8jfm306c9pbc0McH1R0wdtfDd');
define('UC_API', 'http://localhost/discuz/ucenter');
